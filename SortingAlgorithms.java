...
//3. Insertion Sort
//4. Merge Sort
//5. Quick Sort - Hoare's Method
//6. Quick Sort - Lomuto Method
...
class SortingAlgorithms{
	...
	public void quickSort_hoare(int[] arr){

	}

	public void quickSort_lomuto(int[] arr){
    ...
    public static void main(String[] args){
		...
		arr = new int[] {4, 2, 5, 1, 0, 9, 7};
		sort.quickSort_hoare(arr);
		arr = new int[] {4, 2, 5, 1, 0, 9, 7};
		sort.quickSort_lomuto(arr);
	}
}
